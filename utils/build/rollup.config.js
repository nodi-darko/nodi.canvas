...
function addons() {
	...
	return {
		...
		transform( code, id ) {
			...
			code = code.replace( 'build/nodicanvas.module.js', 'src/nodicanvas.js' );
...
let builds = [
	{
		...
		output: [
			{
				format: 'esm',
				file: 'build/nodicanvas.module.js'
			}
		]
	},
	{
		...
		output: [
			{
				format: 'umd',
				name: 'nodicanvas',
				file: 'build/nodicanvas.js',
				indent: '\t'
			},
			{
				format: 'cjs',
				name: 'nodicanvas',
				file: 'build/nodicanvas.cjs',
				indent: '\t'
			}
		]
	},
